...
Used hooks like useEffect, useParams, useState, useLocation, etc.. for some specific purposes.
Styled the pages with CSS.
Deployed in Firebase and can be accessed through my-tube45.web.app across all devices.
If you want to run this project in to your machine create .env file in the root directory and store your api key into VITE_API_KEY variable.
